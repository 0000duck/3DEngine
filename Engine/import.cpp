...
QMatrix4x4 transleAiMatrix4x4(aiMatrix4x4 &tran)
{
...
void Import::nodeHandler(aiNode *node, Scene &sceneObj,
                         QMatrix4x4 &accTransform)
{
    // Recursive func! Very simple, but very small
...
Mesh Import::meshHandler(aiMesh *mesh)
{
    ...
    for(quint32 i = 0; i < mesh->mNumVertices; i++  )
    {
        ...
        int tranI = static_cast<int>(i); // translate quint32 to int
    ...
    // This return copy constructor and i dont know
    // how make it faster!
